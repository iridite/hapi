export default {
  ...
  'settings.chat.reasoningDisplay': 'Reasoning 面板',
  'settings.chat.reasoningDisplay.desc': '控制 Reasoning 面板在流式输出完成后的行为。',
  'settings.chat.reasoningDisplay.default': '默认（输出时展开）',
  'settings.chat.reasoningDisplay.alwaysOpen': '始终展开',
  'settings.chat.reasoningDisplay.alwaysClosed': '始终折叠',
