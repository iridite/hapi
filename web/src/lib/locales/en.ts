export default {
  ...
  'settings.chat.reasoningDisplay': 'Reasoning panel',
  'settings.chat.reasoningDisplay.desc': 'Control how the reasoning panel behaves after streaming.',
  'settings.chat.reasoningDisplay.default': 'Default (open while streaming)',
  'settings.chat.reasoningDisplay.alwaysOpen': 'Always expanded',
  'settings.chat.reasoningDisplay.alwaysClosed': 'Always collapsed',
